...
type UpdateMarketPriceRequest struct {
	...
	Market *types.Market `protobuf:"bytes,1,opt,name=market,proto3" json:"market,omitempty"` // TBD
}
...
var file_operator_proto_rawDesc = []byte{
	...
	0x77, 0x69, 0x74, 0x68, 0x5f, 0x66, 0x65, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e,
	0x2e, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x46, 0x65, 0x65, 0x52, 0x0d,
	0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x57, 0x69, 0x74, 0x68, 0x46, 0x65, 0x65, 0x22, 0x3b, 0x0a,
	...
	0x65, 0x74, 0x52, 0x06, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x22, 0x18, 0x0a, 0x16, 0x55, 0x70,
	...
	0xe3, 0x05, 0x0a, 0x08, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x3d, 0x0a, 0x0d,
	...
	0x72, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x49, 0x0a, 0x11, 0x55,
	...
	0x74, 0x46, 0x65, 0x65, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x40, 0x0a, 0x0e, 0x57,
	...
	0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x31, 0x0a,
	0x09, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x77, 0x61, 0x70, 0x73, 0x12, 0x11, 0x2e, 0x4c, 0x69, 0x73,
	0x74, 0x53, 0x77, 0x61, 0x70, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e,
	0x4c, 0x69, 0x73, 0x74, 0x53, 0x77, 0x61, 0x70, 0x73, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00,
	0x12, 0x43, 0x0a, 0x0f, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4d, 0x61, 0x72, 0x6b, 0x65, 0x74,
	0x46, 0x65, 0x65, 0x12, 0x17, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x4d, 0x61, 0x72, 0x6b,
	0x65, 0x74, 0x46, 0x65, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x52,
...
var file_operator_proto_depIdxs = []int32{
	...
	25, // 7: WithdrawMarketRequest.market:type_name -> Market
	27, // 8: WithdrawMarketRequest.balance_to_withdraw:type_name -> Balance
	0,  // 9: ListSwapsRequest.status:type_name -> SwapStatus
	23, // 10: ListSwapsReply.swaps:type_name -> SwapInfo
	25, // 11: ReportMarketFeeRequest.market:type_name -> Market
	28, // 12: ReportMarketFeeReply.collected_fees:type_name -> Fee
	24, // 13: ReportMarketFeeReply.total_collected_fees_per_asset:type_name -> ReportMarketFeeReply.TotalCollectedFeesPerAssetEntry
	0,  // 14: SwapInfo.status:type_name -> SwapStatus
	28, // 15: SwapInfo.market_fee:type_name -> Fee
	1,  // 16: Operator.DepositMarket:input_type -> DepositMarketRequest
	3,  // 17: Operator.ListDepositMarket:input_type -> ListDepositMarketRequest
	5,  // 18: Operator.DepositFeeAccount:input_type -> DepositFeeAccountRequest
	7,  // 19: Operator.BalanceFeeAccount:input_type -> BalanceFeeAccountRequest
	9,  // 20: Operator.OpenMarket:input_type -> OpenMarketRequest
	11, // 21: Operator.CloseMarket:input_type -> CloseMarketRequest
	15, // 22: Operator.UpdateMarketPrice:input_type -> UpdateMarketPriceRequest
	13, // 23: Operator.UpdateMarketFee:input_type -> UpdateMarketFeeRequest
	17, // 24: Operator.WithdrawMarket:input_type -> WithdrawMarketRequest
	19, // 25: Operator.ListSwaps:input_type -> ListSwapsRequest
	21, // 26: Operator.ReportMarketFee:input_type -> ReportMarketFeeRequest
	2,  // 27: Operator.DepositMarket:output_type -> DepositMarketReply
	4,  // 28: Operator.ListDepositMarket:output_type -> ListDepositMarketReply
	6,  // 29: Operator.DepositFeeAccount:output_type -> DepositFeeAccountReply
	8,  // 30: Operator.BalanceFeeAccount:output_type -> BalanceFeeAccountReply
	10, // 31: Operator.OpenMarket:output_type -> OpenMarketReply
	12, // 32: Operator.CloseMarket:output_type -> CloseMarketReply
	16, // 33: Operator.UpdateMarketPrice:output_type -> UpdateMarketPriceReply
	14, // 34: Operator.UpdateMarketFee:output_type -> UpdateMarketFeeReply
	18, // 35: Operator.WithdrawMarket:output_type -> WithdrawMarketReply
	20, // 36: Operator.ListSwaps:output_type -> ListSwapsReply
	22, // 37: Operator.ReportMarketFee:output_type -> ReportMarketFeeReply

...
public final class TransportGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest,
      network.tdex.transport.TransportOuterClass.SupportedContentTypesReply> getSupportedContentTypesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SupportedContentTypes",
      requestType = network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest.class,
      responseType = network.tdex.transport.TransportOuterClass.SupportedContentTypesReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest,
      network.tdex.transport.TransportOuterClass.SupportedContentTypesReply> getSupportedContentTypesMethod() {
    io.grpc.MethodDescriptor<network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest, network.tdex.transport.TransportOuterClass.SupportedContentTypesReply> getSupportedContentTypesMethod;
      ...
      synchronized (TransportGrpc.class) {
        if ((getSupportedContentTypesMethod = TransportGrpc.getSupportedContentTypesMethod) == null) {
          TransportGrpc.getSupportedContentTypesMethod = getSupportedContentTypesMethod =
              io.grpc.MethodDescriptor.<network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest, network.tdex.transport.TransportOuterClass.SupportedContentTypesReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SupportedContentTypes"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  network.tdex.transport.TransportOuterClass.SupportedContentTypesReply.getDefaultInstance()))
  ...
  public static abstract class TransportImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void supportedContentTypes(network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest request,
        io.grpc.stub.StreamObserver<network.tdex.transport.TransportOuterClass.SupportedContentTypesReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest,
                network.tdex.transport.TransportOuterClass.SupportedContentTypesReply>(
  ...
  public static final class TransportBlockingStub extends io.grpc.stub.AbstractBlockingStub<TransportBlockingStub> {
    ...
    /**
     */
    public network.tdex.transport.TransportOuterClass.SupportedContentTypesReply supportedContentTypes(network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest request) {
  ...
  public static final class TransportFutureStub extends io.grpc.stub.AbstractFutureStub<TransportFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<network.tdex.transport.TransportOuterClass.SupportedContentTypesReply> supportedContentTypes(
        network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUPPORTED_CONTENT_TYPES:
          serviceImpl.supportedContentTypes((network.tdex.transport.TransportOuterClass.SupportedContentTypesRequest) request,
              (io.grpc.stub.StreamObserver<network.tdex.transport.TransportOuterClass.SupportedContentTypesReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class TransportBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return network.tdex.transport.TransportOuterClass.getDescriptor();
    }

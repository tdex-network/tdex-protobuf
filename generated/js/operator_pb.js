...
proto.ClaimMarketDepositRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    types_pb.TxOutpoint.toObject, includeInstance)
  };
...
proto.ClaimMarketDepositRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new types_pb.TxOutpoint;
      reader.readMessage(value,types_pb.TxOutpoint.deserializeBinaryFromReader);
...
proto.ClaimMarketDepositRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      types_pb.TxOutpoint.serializeBinaryToWriter
    );
  }
};
...
proto.ClaimMarketDepositRequest.prototype.getOutpointsList = function() {
  return /** @type{!Array<!proto.TxOutpoint>} */ (
    jspb.Message.getRepeatedWrapperField(this, types_pb.TxOutpoint, 2));
};
...
proto.ClaimFeeDepositReply.prototype.getOutpointsList = function() {
  return /** @type{!Array<!proto.TxOutpoint>} */ (
    jspb.Message.getRepeatedWrapperField(this, types_pb.TxOutpoint, 1));
};

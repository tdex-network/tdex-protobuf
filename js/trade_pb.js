...
proto.BalancesReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.BalanceWithFee.toObject, includeInstance)
  };
...
proto.BalancesReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.BalanceWithFee;
      reader.readMessage(value,proto.BalanceWithFee.deserializeBinaryFromReader);
...
proto.BalancesReply.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.BalanceWithFee.serializeBinaryToWriter
    );
  }
};
...
proto.BalancesReply.prototype.getBalancesList = function() {
  return /** @type{!Array<!proto.BalanceWithFee>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.BalanceWithFee, 1));
};
...
proto.MarketPriceReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.PriceWithFee.toObject, includeInstance)
  };
...
proto.MarketPriceReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.PriceWithFee;
      reader.readMessage(value,proto.PriceWithFee.deserializeBinaryFromReader);
      msg.addPrices(value);
      break;
    default:
      reader.skipField();
...
proto.MarketPriceReply.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.PriceWithFee.serializeBinaryToWriter
    );
  }
};
...
proto.MarketPriceReply.prototype.getPricesList = function() {
  return /** @type{!Array<!proto.PriceWithFee>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.PriceWithFee, 1));
};
...
/**
 * optional int64 expiry_time_unix = 3;
 * @return {number}
 */

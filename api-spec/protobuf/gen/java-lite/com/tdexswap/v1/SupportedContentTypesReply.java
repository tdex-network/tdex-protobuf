...
public  final class SupportedContentTypesReply extends
      ...
      java.lang.Integer, com.tdexswap.v1.ContentType> acceptedTypes_converter_ =
          new com.google.protobuf.Internal.ListAdapter.Converter<
            ...
            public com.tdexswap.v1.ContentType convert(java.lang.Integer from) {
              com.tdexswap.v1.ContentType result = com.tdexswap.v1.ContentType.forNumber(from);
  ...
  public com.tdexswap.v1.ContentType getAcceptedTypes(int index) {
    com.tdexswap.v1.ContentType result = com.tdexswap.v1.ContentType.forNumber(acceptedTypes_.getInt(index));
    return result == null ? com.tdexswap.v1.ContentType.UNRECOGNIZED : result;
  }
  /**
   * <code>repeated .tdexswap.v1.ContentType accepted_types = 1 [json_name = "acceptedTypes"];</code>
   ...
   */
  private void addAcceptedTypes(com.tdexswap.v1.ContentType value) {
    value.getClass();
  ensureAcceptedTypesIsMutable();
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.tdexswap.v1.SupportedContentTypesReply, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.tdexswap.v1.SupportedContentTypesReply();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.tdexswap.v1.SupportedContentTypesReply> parser = PARSER;
        if (parser == null) {
          synchronized (com.tdexswap.v1.SupportedContentTypesReply.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.tdexswap.v1.SupportedContentTypesReply>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }

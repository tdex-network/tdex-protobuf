...
@javax.annotation.Generated(
    ...
    comments = "Source: tdex/v1/transport.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class TransportGrpc {

  private TransportGrpc() {}

  public static final String SERVICE_NAME = "tdex.v1.Transport";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.SupportedContentTypesRequest,
      com.tdex.v1.SupportedContentTypesReply> getSupportedContentTypesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SupportedContentTypes",
      requestType = com.tdex.v1.SupportedContentTypesRequest.class,
      responseType = com.tdex.v1.SupportedContentTypesReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tdex.v1.SupportedContentTypesRequest,
      com.tdex.v1.SupportedContentTypesReply> getSupportedContentTypesMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.SupportedContentTypesRequest, com.tdex.v1.SupportedContentTypesReply> getSupportedContentTypesMethod;
      ...
      synchronized (TransportGrpc.class) {
        if ((getSupportedContentTypesMethod = TransportGrpc.getSupportedContentTypesMethod) == null) {
          TransportGrpc.getSupportedContentTypesMethod = getSupportedContentTypesMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.SupportedContentTypesRequest, com.tdex.v1.SupportedContentTypesReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SupportedContentTypes"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.SupportedContentTypesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.SupportedContentTypesReply.getDefaultInstance()))
  ...
  public static abstract class TransportImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void supportedContentTypes(com.tdex.v1.SupportedContentTypesRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.SupportedContentTypesReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.tdex.v1.SupportedContentTypesRequest,
                com.tdex.v1.SupportedContentTypesReply>(
  ...
  public static final class TransportBlockingStub extends io.grpc.stub.AbstractBlockingStub<TransportBlockingStub> {
    ...
    /**
     */
    public com.tdex.v1.SupportedContentTypesReply supportedContentTypes(com.tdex.v1.SupportedContentTypesRequest request) {
  ...
  public static final class TransportFutureStub extends io.grpc.stub.AbstractFutureStub<TransportFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tdex.v1.SupportedContentTypesReply> supportedContentTypes(
        com.tdex.v1.SupportedContentTypesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUPPORTED_CONTENT_TYPES:
          serviceImpl.supportedContentTypes((com.tdex.v1.SupportedContentTypesRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.SupportedContentTypesReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class TransportBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.tdex.v1.TransportProto.getDescriptor();
    }

...
@javax.annotation.Generated(
    ...
    comments = "Source: tdex/v1/trade.proto")
@io.grpc.stub.annotations.GrpcGenerated
public final class TradeGrpc {

  private TradeGrpc() {}

  public static final String SERVICE_NAME = "tdex.v1.Trade";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.MarketsRequest,
      com.tdex.v1.MarketsReply> getMarketsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Markets",
      requestType = com.tdex.v1.MarketsRequest.class,
      responseType = com.tdex.v1.MarketsReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tdex.v1.MarketsRequest,
      com.tdex.v1.MarketsReply> getMarketsMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.MarketsRequest, com.tdex.v1.MarketsReply> getMarketsMethod;
      ...
      synchronized (TradeGrpc.class) {
        if ((getMarketsMethod = TradeGrpc.getMarketsMethod) == null) {
          TradeGrpc.getMarketsMethod = getMarketsMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.MarketsRequest, com.tdex.v1.MarketsReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Markets"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.MarketsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.MarketsReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.BalancesRequest,
      com.tdex.v1.BalancesReply> getBalancesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Balances",
      requestType = com.tdex.v1.BalancesRequest.class,
      responseType = com.tdex.v1.BalancesReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tdex.v1.BalancesRequest,
      com.tdex.v1.BalancesReply> getBalancesMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.BalancesRequest, com.tdex.v1.BalancesReply> getBalancesMethod;
    if ((getBalancesMethod = TradeGrpc.getBalancesMethod) == null) {
      synchronized (TradeGrpc.class) {
        if ((getBalancesMethod = TradeGrpc.getBalancesMethod) == null) {
          TradeGrpc.getBalancesMethod = getBalancesMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.BalancesRequest, com.tdex.v1.BalancesReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Balances"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.BalancesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.BalancesReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.MarketPriceRequest,
      com.tdex.v1.MarketPriceReply> getMarketPriceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "MarketPrice",
      requestType = com.tdex.v1.MarketPriceRequest.class,
      responseType = com.tdex.v1.MarketPriceReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tdex.v1.MarketPriceRequest,
      com.tdex.v1.MarketPriceReply> getMarketPriceMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.MarketPriceRequest, com.tdex.v1.MarketPriceReply> getMarketPriceMethod;
    if ((getMarketPriceMethod = TradeGrpc.getMarketPriceMethod) == null) {
      synchronized (TradeGrpc.class) {
        if ((getMarketPriceMethod = TradeGrpc.getMarketPriceMethod) == null) {
          TradeGrpc.getMarketPriceMethod = getMarketPriceMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.MarketPriceRequest, com.tdex.v1.MarketPriceReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "MarketPrice"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.MarketPriceRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.MarketPriceReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.TradeProposeRequest,
      com.tdex.v1.TradeProposeReply> getTradeProposeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TradePropose",
      requestType = com.tdex.v1.TradeProposeRequest.class,
      responseType = com.tdex.v1.TradeProposeReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.tdex.v1.TradeProposeRequest,
      com.tdex.v1.TradeProposeReply> getTradeProposeMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.TradeProposeRequest, com.tdex.v1.TradeProposeReply> getTradeProposeMethod;
    if ((getTradeProposeMethod = TradeGrpc.getTradeProposeMethod) == null) {
      synchronized (TradeGrpc.class) {
        if ((getTradeProposeMethod = TradeGrpc.getTradeProposeMethod) == null) {
          TradeGrpc.getTradeProposeMethod = getTradeProposeMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.TradeProposeRequest, com.tdex.v1.TradeProposeReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TradePropose"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.TradeProposeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.TradeProposeReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.ProposeTradeRequest,
      com.tdex.v1.ProposeTradeReply> getProposeTradeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ProposeTrade",
      requestType = com.tdex.v1.ProposeTradeRequest.class,
      responseType = com.tdex.v1.ProposeTradeReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tdex.v1.ProposeTradeRequest,
      com.tdex.v1.ProposeTradeReply> getProposeTradeMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.ProposeTradeRequest, com.tdex.v1.ProposeTradeReply> getProposeTradeMethod;
    if ((getProposeTradeMethod = TradeGrpc.getProposeTradeMethod) == null) {
      synchronized (TradeGrpc.class) {
        if ((getProposeTradeMethod = TradeGrpc.getProposeTradeMethod) == null) {
          TradeGrpc.getProposeTradeMethod = getProposeTradeMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.ProposeTradeRequest, com.tdex.v1.ProposeTradeReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ProposeTrade"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.ProposeTradeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.ProposeTradeReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.TradeCompleteRequest,
      com.tdex.v1.TradeCompleteReply> getTradeCompleteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TradeComplete",
      requestType = com.tdex.v1.TradeCompleteRequest.class,
      responseType = com.tdex.v1.TradeCompleteReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.tdex.v1.TradeCompleteRequest,
      com.tdex.v1.TradeCompleteReply> getTradeCompleteMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.TradeCompleteRequest, com.tdex.v1.TradeCompleteReply> getTradeCompleteMethod;
    if ((getTradeCompleteMethod = TradeGrpc.getTradeCompleteMethod) == null) {
      synchronized (TradeGrpc.class) {
        if ((getTradeCompleteMethod = TradeGrpc.getTradeCompleteMethod) == null) {
          TradeGrpc.getTradeCompleteMethod = getTradeCompleteMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.TradeCompleteRequest, com.tdex.v1.TradeCompleteReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TradeComplete"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.TradeCompleteRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.TradeCompleteReply.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.tdex.v1.CompleteTradeRequest,
      com.tdex.v1.CompleteTradeReply> getCompleteTradeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CompleteTrade",
      requestType = com.tdex.v1.CompleteTradeRequest.class,
      responseType = com.tdex.v1.CompleteTradeReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.tdex.v1.CompleteTradeRequest,
      com.tdex.v1.CompleteTradeReply> getCompleteTradeMethod() {
    io.grpc.MethodDescriptor<com.tdex.v1.CompleteTradeRequest, com.tdex.v1.CompleteTradeReply> getCompleteTradeMethod;
    if ((getCompleteTradeMethod = TradeGrpc.getCompleteTradeMethod) == null) {
      synchronized (TradeGrpc.class) {
        if ((getCompleteTradeMethod = TradeGrpc.getCompleteTradeMethod) == null) {
          TradeGrpc.getCompleteTradeMethod = getCompleteTradeMethod =
              io.grpc.MethodDescriptor.<com.tdex.v1.CompleteTradeRequest, com.tdex.v1.CompleteTradeReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CompleteTrade"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.CompleteTradeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.tdex.v1.CompleteTradeReply.getDefaultInstance()))
  ...
  public static abstract class TradeImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void markets(com.tdex.v1.MarketsRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.MarketsReply> responseObserver) {
     ...
     * </pre>
     */
    public void balances(com.tdex.v1.BalancesRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.BalancesReply> responseObserver) {
     ...
     * </pre>
     */
    public void marketPrice(com.tdex.v1.MarketPriceRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.MarketPriceReply> responseObserver) {
     ...
     * </pre>
     */
    public void tradePropose(com.tdex.v1.TradeProposeRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.TradeProposeReply> responseObserver) {
     ...
     * </pre>
     */
    public void proposeTrade(com.tdex.v1.ProposeTradeRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.ProposeTradeReply> responseObserver) {
     ...
     * </pre>
     */
    public void tradeComplete(com.tdex.v1.TradeCompleteRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.TradeCompleteReply> responseObserver) {
     ...
     * </pre>
     */
    public void completeTrade(com.tdex.v1.CompleteTradeRequest request,
        io.grpc.stub.StreamObserver<com.tdex.v1.CompleteTradeReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.tdex.v1.MarketsRequest,
                com.tdex.v1.MarketsReply>(
                  this, METHODID_MARKETS)))
          .addMethod(
            getBalancesMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.tdex.v1.BalancesRequest,
                com.tdex.v1.BalancesReply>(
                  this, METHODID_BALANCES)))
          .addMethod(
            getMarketPriceMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.tdex.v1.MarketPriceRequest,
                com.tdex.v1.MarketPriceReply>(
                  this, METHODID_MARKET_PRICE)))
          .addMethod(
            getTradeProposeMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.tdex.v1.TradeProposeRequest,
                com.tdex.v1.TradeProposeReply>(
                  this, METHODID_TRADE_PROPOSE)))
          .addMethod(
            getProposeTradeMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.tdex.v1.ProposeTradeRequest,
                com.tdex.v1.ProposeTradeReply>(
                  this, METHODID_PROPOSE_TRADE)))
          .addMethod(
            getTradeCompleteMethod(),
            io.grpc.stub.ServerCalls.asyncServerStreamingCall(
              new MethodHandlers<
                com.tdex.v1.TradeCompleteRequest,
                com.tdex.v1.TradeCompleteReply>(
                  this, METHODID_TRADE_COMPLETE)))
          .addMethod(
            getCompleteTradeMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.tdex.v1.CompleteTradeRequest,
                com.tdex.v1.CompleteTradeReply>(
  ...
  public static final class TradeBlockingStub extends io.grpc.stub.AbstractBlockingStub<TradeBlockingStub> {
     ...
     * </pre>
     */
    public com.tdex.v1.MarketsReply markets(com.tdex.v1.MarketsRequest request) {
     ...
     * </pre>
     */
    public com.tdex.v1.BalancesReply balances(com.tdex.v1.BalancesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public com.tdex.v1.MarketPriceReply marketPrice(com.tdex.v1.MarketPriceRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public java.util.Iterator<com.tdex.v1.TradeProposeReply> tradePropose(
        com.tdex.v1.TradeProposeRequest request) {
     ...
     * </pre>
     */
    public com.tdex.v1.ProposeTradeReply proposeTrade(com.tdex.v1.ProposeTradeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public java.util.Iterator<com.tdex.v1.TradeCompleteReply> tradeComplete(
        com.tdex.v1.TradeCompleteRequest request) {
      return io.grpc.stub.ClientCalls.blockingServerStreamingCall(
     ...
     * </pre>
     */
    public com.tdex.v1.CompleteTradeReply completeTrade(com.tdex.v1.CompleteTradeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class TradeFutureStub extends io.grpc.stub.AbstractFutureStub<TradeFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tdex.v1.MarketsReply> markets(
        com.tdex.v1.MarketsRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tdex.v1.BalancesReply> balances(
        com.tdex.v1.BalancesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tdex.v1.MarketPriceReply> marketPrice(
        com.tdex.v1.MarketPriceRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tdex.v1.ProposeTradeReply> proposeTrade(
        com.tdex.v1.ProposeTradeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.tdex.v1.CompleteTradeReply> completeTrade(
        com.tdex.v1.CompleteTradeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MARKETS:
          serviceImpl.markets((com.tdex.v1.MarketsRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.MarketsReply>) responseObserver);
          break;
        case METHODID_BALANCES:
          serviceImpl.balances((com.tdex.v1.BalancesRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.BalancesReply>) responseObserver);
          break;
        case METHODID_MARKET_PRICE:
          serviceImpl.marketPrice((com.tdex.v1.MarketPriceRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.MarketPriceReply>) responseObserver);
          break;
        case METHODID_TRADE_PROPOSE:
          serviceImpl.tradePropose((com.tdex.v1.TradeProposeRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.TradeProposeReply>) responseObserver);
          break;
        case METHODID_PROPOSE_TRADE:
          serviceImpl.proposeTrade((com.tdex.v1.ProposeTradeRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.ProposeTradeReply>) responseObserver);
          break;
        case METHODID_TRADE_COMPLETE:
          serviceImpl.tradeComplete((com.tdex.v1.TradeCompleteRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.TradeCompleteReply>) responseObserver);
          break;
        case METHODID_COMPLETE_TRADE:
          serviceImpl.completeTrade((com.tdex.v1.CompleteTradeRequest) request,
              (io.grpc.stub.StreamObserver<com.tdex.v1.CompleteTradeReply>) responseObserver);
          break;
        default:
  ...
  private static abstract class TradeBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.tdex.v1.TradeProto.getDescriptor();
    }
